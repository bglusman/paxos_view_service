...
func check(t *testing.T, ck *Clerk, p string, b string, n uint, callLine uint) {
	view, _ := ck.Get()
	if view.Primary != p {
		// t.Fatalf("view:", view.Viewnum, "callLine:", callLine)
		t.Fatalf("wanted primary %v, got %v on %v", p, view.Primary, callLine)
	}
	if view.Backup != b {
		t.Fatalf("wanted backup %v, got %v on %v", b, view.Backup, callLine)
	}
	if n != 0 && n != view.Viewnum {
		t.Fatalf("wanted viewnum %v, got %v on %v", n, view.Viewnum, callLine)
	}
	if ck.Primary() != p {
		t.Fatalf("wanted clerk primary %v, got %v on %v", p, ck.Primary(), callLine)
	}
}
...
func Test1(t *testing.T) {
...

	{
		...
		fmt.Printf(" expected viewnum:", vx.Viewnum+1)
		check(t, ck1, ck1.me, ck2.me, vx.Viewnum+1, 78)
	}
	fmt.Printf("  ... Passed\n")
...

	{
		...
		check(t, ck2, ck2.me, "", vx.Viewnum+1, 95)
	}
	fmt.Printf("  ... Passed\n")
...

	{
		...
		check(t, ck2, ck2.me, ck1.me, vx.Viewnum+1, 113)
	}
	fmt.Printf("  ... Passed\n")
...

	{
		...
		check(t, ck1, ck1.me, ck3.me, vx.Viewnum+1, 135)
	}
	fmt.Printf("  ... Passed\n")
...

	{
		...
		check(t, ck1, ck3.me, ck1.me, vx.Viewnum+1, 196)
		vy, _ := ck1.Get()
		...
		check(t, ck2, ck3.me, ck1.me, vy.Viewnum, 207)
	}
	fmt.Printf("  ... Passed\n")
